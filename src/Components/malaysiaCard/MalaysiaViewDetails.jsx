...
const MalaysiaViewDetails = () => {
    const MalaysiaViewDetails = useLoaderData();
    const {_id} = useParams();
    const MalaysiaDetails = MalaysiaViewDetails.find(detail => detail._id ===_id);
    // console.log(bnDetails);
    const { seasonality,cost, image, time, visitors, CountryName, spotName, location, description } = MalaysiaDetails;

    return (
        <div>
             <div>
                    <div>
            <Helmet><title>Malaysia-View Details</title></Helmet>
            <div>
                <section className=" ">
...
export default MalaysiaViewDetails;