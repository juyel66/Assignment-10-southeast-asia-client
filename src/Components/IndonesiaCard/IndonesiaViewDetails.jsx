...
const IndonesiaViewDetails = () => {
    const IndonesiaViewDetails = useLoaderData();
    const {_id} = useParams();
    const IndonesiaDetails = IndonesiaViewDetails.find(detail => detail._id ===_id);
    // console.log(bnDetails);
    const { seasonality,cost, image, time, visitors, CountryName, spotName, location, description } = IndonesiaDetails;
    return (
        <div>
                 <div>
                    <div>
            <Helmet><title>Indonesia-View Details</title></Helmet>
            <div>
                <section className=" ">
...
export default IndonesiaViewDetails;