    ...
    <>
      <li>
        <NavLink
          className={({ isActive }) =>
            isActive
              ? "btn btn-outline btn-success text-bold text-xl"
              : "text-xl font-bold"
          }
          to="/"
        >
    ...
    <div>
      <div className="navbar  rounded-xl ">
        <div className="navbar-start">
          ...
          <a className="btn btn-ghost lg:text-xl text-[10px] lg:font-extrabold font-bold rounded-xl border-2    lg:w-[180px] w-[100px] ">
            Asia Wonders
          </a>
        </div>
