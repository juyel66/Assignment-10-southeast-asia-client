...
const ThailandViewDetails = () => {
    const ThailandViewDetails = useLoaderData();
    const {_id} = useParams();
    const ThailandDetails = ThailandViewDetails.find(detail => detail._id ===_id);
    // console.log(bnDetails);
    const { seasonality,cost, image, time, visitors, CountryName, spotName, location, description } = ThailandDetails;

    return (
        <div>
                    <div>
                    <div>
            <Helmet><title>Thailand-View Details</title></Helmet>
            <div>
                <section className=" ">
...
export default ThailandViewDetails;