      ...
      <div data-aos ="fade-down" className="card h-[400px] mt-5 card-compact border-2 border-gray-500  bg-base-100 shadow-xl">
        ...
        <div className="card-body">
          ...
          <div className="card-actions">
            <Link  to={`/BnViewDetails/${_id}`} className="w-full"><button className="btn w-full bg-gray-500 text-white text-xl ">View Details</button></Link>
          </div>
        </div>
      </div>
    </div>
...
BnSingleCard.propTypes ={
    item:PropTypes.node.isRequired
}

export default BnSingleCard;