...
const ViewDetailsSpots = () => {
    const SpotViewDetails = useLoaderData();
    const {_id} = useParams();
    // const idInt = parseInt(_id);

    const viewDetails = SpotViewDetails.find(detail => detail._id ===_id);
    console.log(viewDetails)

    const { cost,seasonality,image,time,visitors,CountryName,spotName,location,description} = viewDetails;
...
export default ViewDetailsSpots;